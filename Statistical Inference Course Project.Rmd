...
Note that the vertical blue solid line plotted on the histogram graph in Figure-2 represents the sample mean $\bar{X}$ which is positioned ever so closely next to the theoretical mean $\mu$, where $t.value$ tells us if the $\bar{X}$ will fall on the left or right of the $\mu$.  
