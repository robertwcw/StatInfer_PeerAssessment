...
tg.oj <- subset(tg, as.numeric(supp) == 1)
tg.vc <- subset(tg, as.numeric(supp) == 2)

B.tg <- bootstrap(tg, B)
i <- as.numeric(B.tg$.id)



for (i in as.numeric(B.tg$.id)) print(tg[B.tg$strap[[i]][[2]],]$len)
tg[B.tg$strap[[6]][[2]],]$len

mapplay(mean, tg[B.tg$strap[[6]][[2]],])
```
